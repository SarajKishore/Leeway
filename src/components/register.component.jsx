...
import {setFname,setLname,setEmail,setPassword} from '../actions/index';
        ...
        return(
          <div> 
            ...
            <Form.Group widths='equal'>
              ...
              <Form.Input fluid name="lname" label='Last name' placeholder='Last name' onChange={this.handleChange} value={lname} />
            </Form.Group>
